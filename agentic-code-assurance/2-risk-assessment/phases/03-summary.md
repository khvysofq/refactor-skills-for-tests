...
> **前置条件**：Phase 02 已产出审查结果（任务列表或临时清单）；从 [Workflow.md](../Workflow.md) 决策树 Q3 为「否」进入。  
...
- 从 [Workflow.md](../Workflow.md) 决策树判断 Q3 为「否」（任务列表未生成或未满足约定结构）
...
**加载 Skill**：阅读并执行 → [Skill 03: 汇总与产出](../skills/skill-03-summary.md)

**按需查阅**：撰写或检查任务列表时阅读 [任务列表产出结构约定](../definitions/task_output_structure.md)、[任务列表模板](../templates/task_list.md)
...
- [ ] **每条任务含** [task_output_structure](../definitions/task_output_structure.md) **规定的必填字段**：位置、简要描述、风险类型、关联模块
...
- [ ] 格式与 [模板](../templates/task_list.md) 一致，便于阶段三解析
...
**执行**：立即加载 [Skill 03](../skills/skill-03-summary.md) 开始执行
